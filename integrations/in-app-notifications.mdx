...
<Tip>
As of **v0.2.0** the SDK bundles `socket.io-client`, so `npm i @onchainsuite/sdk` is all you need — no second install. (Older docs told you to add `socket.io-client` separately; that's no longer required on the npm path.)
</Tip>
